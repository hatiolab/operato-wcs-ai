...
/**
 * 메뉴 메타 데이터 기반 차트 화면 생성 Mixin
 ***************************************
 * @param {*} superClass 
 * @returns 
 */
export const MetaChartMixin = (superClass) => class extends SearchFormRenderMixin(CustomButtonMixin(superClass)) {
    /**
  ...
  /**
   * 서비스 호출에 대한 response로 부터 차트 데이터 셋 설정
   ***************************
  ...
  /**
   * fetchResult내 chartDataSet으로 차트 구성
   ********************************
  ...
  /**
   * 메뉴 메타와 fetchResult내 조회한 데이터로 차트 구성
   ********************************
   * @param {Object} fetchResult 
   */
