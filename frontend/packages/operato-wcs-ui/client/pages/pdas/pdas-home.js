...
class PdasHome extends localize(i18next)(PageView) {
  static get styles() {
    return [
      css `
        :host {
  ...
  render() {
    ...
    return html `
      <h2>P-DAS</h2>
      <p page-description>
        이 메뉴는 Operato Logistics P-DAS 업무를 위한 메뉴입니다.
      </p>
      
      <img src="/assets/images/pdas/pdas-home.png" />      
    `
  }
...
window.customElements.define('pdas-home', PdasHome)