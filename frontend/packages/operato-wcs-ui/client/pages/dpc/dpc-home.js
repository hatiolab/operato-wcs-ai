...
class DpcHome extends localize(i18next)(PageView) {
  static get styles() {
    return [
      css `
        :host {
  ...
  render() {
    ...
    return html `
      <h2>Digital Picking System</h2>
      <p page-description>
        이 메뉴는 Operato Logistics Digital Picking System 업무를 위한 메뉴입니다.
      </p>
      
      <img src="/assets/images/dpc/dpc-home.png" />      
    `
  }
...
window.customElements.define('dpc-home', DpcHome)