...
class EquipmentHome extends localize(i18next)(PageView) {
  static get styles() {
    return [
      css `
        :host {
  ...
  render() {
    ...
    return html `
      <h2>설비 관리</h2>
      <p page-description>
        이 메뉴는 Operato Logistics 설비 정보를 관리하는 메뉴입니다.
      </p>
      
      <img src="/assets/images/equipment/equipment-home.png" />      
    `
  }
...
window.customElements.define('equipment-home', EquipmentHome)