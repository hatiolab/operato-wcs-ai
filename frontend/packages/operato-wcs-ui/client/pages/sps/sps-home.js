...
class SpsHome extends localize(i18next)(PageView) {
  static get styles() {
    return [
      css `
        :host {
  ...
  render() {
    ...
    return html `
      <h2>단포</h2>
      <p page-description>
        이 메뉴는 Operato Logistics 단포 업무를 위한 메뉴입니다.
      </p>
      
      <img src="/assets/images/sps/sps-home.png" />      
    `
  }
...
window.customElements.define('sps-home', SpsHome)