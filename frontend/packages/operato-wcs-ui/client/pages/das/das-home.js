...
class DasHome extends localize(i18next)(PageView) {
  static get styles() {
    return [
      css `
        :host {
  ...
  render() {
    ...
    return html `
      <h2>Put To Light</h2>
      <p page-description>
        이 메뉴는 Operato Logistics Put To Light 업무를 위한 메뉴입니다.
      </p>
      
      <img src="/assets/images/das/das-home.png" />      
    `
  }
...
window.customElements.define('das-home', DasHome)