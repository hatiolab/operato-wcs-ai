...
class MasterHome extends localize(i18next)(PageView) {
  static get styles() {
    return [
      css `
        :host {
  ...
  render() {
    ...
    return html `
      <h2>마스터 관리</h2>
      <p page-description>
        이 메뉴는 Operato Logistics 기준 정보를 관리하는 메뉴입니다.
      </p>
      
      <img src="/assets/images/master/master-home.png" />      
    `
  }
...
window.customElements.define('master-home', MasterHome)