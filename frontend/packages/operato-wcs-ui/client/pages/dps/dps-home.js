...
class DpsHome extends localize(i18next)(PageView) {
  static get styles() {
    return [
      css `
        :host {
  ...
  render() {
    ...
    return html `
      <h2>Pick To Light</h2>
      <p page-description>
        이 메뉴는 Operato Logistics Pick To Light 업무를 위한 메뉴입니다.
      </p>
      
      <img src="/assets/images/dps/dps-home.png" />      
    `
  }
...
window.customElements.define('dps-home', DpsHome)