...
@ServiceDesc(description = "Station Service API")
public class StationController extends AbstractRestService {
	...
	public Station findOne(@PathVariable("id") String id) {
	...
	public Station create(@RequestBody Station input) {
		return this.createOne(input);
	}

	@RequestMapping(value = "/{id}", method = RequestMethod.PUT, consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
	@ApiDesc(description = "Update")
	public Station update(@PathVariable("id") String id, @RequestBody Station input) {
