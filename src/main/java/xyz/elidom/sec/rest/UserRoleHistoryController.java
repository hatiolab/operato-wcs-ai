...
@RequestMapping("/rest/user_role_histories")
@ServiceDesc(description = "UserRoleHistory Service API")
public class UserRoleHistoryController extends AbstractRestService {

	@Override
	protected Class<?> entityClass() {
		return UserRoleHistory.class;
	}
	...
	public UserRoleHistory findOne(@PathVariable("id") String id) {
	...
	public UserRoleHistory create(@RequestBody UserRoleHistory input) {
		return this.createOne(input);
	}

	@RequestMapping(value = "/{id}", method = RequestMethod.PUT, consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
	@ApiDesc(description = "Update")
	public UserRoleHistory update(@PathVariable("id") String id, @RequestBody UserRoleHistory input) {
	...
	public Boolean multipleUpdate(@RequestBody List<UserRoleHistory> list) {
