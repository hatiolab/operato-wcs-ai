...
@Table(name = "menu_detail_columns", idStrategy = GenerationRule.UUID, uniqueFields = "menuDetailId,name", indexes = { 
	@Index(name = "ix_menu_detail_col_0", columnList = "domain_id,menu_detail_id,name", unique = true),
	@Index(name = "ix_menu_detail_col_1", columnList = "menu_detail_id,rank")
})
public class MenuDetailColumn extends DomainStampHook {

	/**
	 * SerialVersion UID
	 */
	private static final long serialVersionUID = 1335677377744950915L;
	...
	public MenuDetailColumn() {
	}
	
	public MenuDetailColumn(String menuDetailId) {
		this.menuDetailId = menuDetailId;
	}
	
	public MenuDetailColumn(String menuDetailId, String name) {
		this.menuDetailId = menuDetailId;
		this.name = name;
	}
