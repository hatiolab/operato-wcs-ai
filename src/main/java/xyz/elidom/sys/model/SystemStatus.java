...
public class SystemStatus {
	...
	public static SystemStatus fromMap(Map<String, Object> map) {
		...
		if(map != null) {
			ss.setName(ValueUtil.toString(map.get("name")));
			ss.setVersion(ValueUtil.toString(map.get("version")));
			ss.setArch(ValueUtil.toString(map.get("arch")));
	...
	private static int valueToInt(Object value) {
		if(ValueUtil.isEmpty(value)) {
			...
			return ValueUtil.toInteger(value, 0).intValue();
		}		
	}
	...
	private static double valueToDouble(Object value) {
		if(ValueUtil.isEmpty(value)) {
			...
			return ValueUtil.toDouble(value, 0D).doubleValue();
		}
	}
	...
	private static long valueToLong(Object value) {
		if(ValueUtil.isEmpty(value)) {
			...
			return ValueUtil.toLong(value, 0L).longValue();
		}
	}
	...
	public String toString() {
		...
		buffer.append("name:").append(this.name).append(OrmConstants.DOT);
		buffer.append("version:").append(this.version).append(OrmConstants.DOT);
		buffer.append("arch:").append(this.arch).append(OrmConstants.DOT);
		buffer.append("availableProcessors:").append(this.availableProcessors).append(OrmConstants.DOT);
		buffer.append("systemLoadAverage:").append(this.systemLoadAverage).append(OrmConstants.DOT);
		buffer.append("systemCpuLoad:").append(this.systemCpuLoad).append(OrmConstants.DOT);
		buffer.append("processCpuTime:").append(this.processCpuTime).append(OrmConstants.DOT);
		buffer.append("processCpuLoad:").append(this.processCpuLoad).append(OrmConstants.DOT);
		buffer.append("totalPhysicalMemorySize:").append(this.totalPhysicalMemorySize).append(OrmConstants.DOT);
		buffer.append("freePhysicalMemorySize:").append(this.freePhysicalMemorySize).append(OrmConstants.DOT);
		buffer.append("committedVirtualMemorySize:").append(this.committedVirtualMemorySize).append(OrmConstants.DOT);
		buffer.append("totalSwapSpaceSize:").append(this.totalSwapSpaceSize).append(OrmConstants.DOT);
		buffer.append("freeSwapSpaceSize:").append(this.freeSwapSpaceSize).append(OrmConstants.DOT);
		buffer.append("totalDiskSpace:").append(this.totalDiskSpace).append(OrmConstants.DOT);
