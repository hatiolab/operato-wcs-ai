...
//                            callResult[j] = ValueUtil.toFloat(((Double)callResult[j]));
//                    }
//                    else
//                    {    
...
//	            break;
//	        default:
//	            throw new PSQLException(GT.tr("Unsupported Types value: {0}", ValueUtil.toInteger(targetSqlType)), PSQLState.INVALID_PARAMETER_TYPE);
//        }
//    }
//
