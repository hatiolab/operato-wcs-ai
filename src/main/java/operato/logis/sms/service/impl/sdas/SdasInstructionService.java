...
public class SdasInstructionService extends AbstractQueryService implements IInstructionService {
	 ...
	 * 커스텀 서비스 - 대상 분류
	 */
	private static final String DIY_CLASSIFY_ORDERS = "diy-sdas-classify-orders";
	 ...
	 * @param event
	 */
	@EventListener(classes = BatchInstructEvent.class, condition = "#event.eventType == 40 and #event.eventStep == 3 and  #event.jobType == 'SDAS' ")
