 ...
 * @author shortstop
 */
@Component("dpsPreprocessService")
public class DpsPreprocessService extends AbstractExecutionService implements IPreprocessService {

	/**
	 * 주문 가공 처리 커스텀 서비스
	 */
	public static final String CUSTOM_DPS_BATCH_PREPROCESS = "diy-dps-batch-preprocess";
	...
	public List<JobBatch> completePreprocess(JobBatch batch, Object... params) {
		...
		// 2. 커스텀 서비스로 주문 가공 처리
		this.customService.doCustomService(batch.getDomainId(), CUSTOM_DPS_BATCH_PREPROCESS, ValueUtil.newMap("batch", batch));
